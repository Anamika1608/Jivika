    ...
    <div className="bg-green-50 rounded-lg shadow-md my-6 overflow-hidden">
      <div className="bg-[#CADACB] p-6 sm:p-14 sm:rounded-se-[110px]">
        <div className="sm:flex justify-between items-center">
          <div>
            <h2 className="text-2xl font-bold text-green-800 mb-2">LAVENDER PLANT</h2>
          ...
          <div className="flex justify-center mt-4 sm:mt-0">
            <img src="/p5.svg" alt="Lavender Plant" className="object-contain scale-[1.2] sm:ml-10 p-4 sm:scale-[1.5] rounded-lg" />
          </div>
        </div>
      </div>
      ...
      <div className="p-6  bg-white sm:ml-44 sm:py-5 sm:w-1/3">
        ...
        <p className="text-gray-600 text-md mb-4">
          Lavender has calming, anti-anxiety, and anti-inflammatory properties. It's used to reduce stress, promote relaxation, and alleviate sleep disorders. Its essential oil is popular in aromatherapy and skincare for its soothing effects.
        </p>
